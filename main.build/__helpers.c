...
PyObject *CALL_FUNCTION_WITH_ARGS23(PyObject *called, PyObject **args) {
    CHECK_OBJECT(called);
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (function->m_args_simple && 23 == function->m_args_positional_count){
            ...
            if (parseArgumentsPos(function, python_pars, args, 23)) {
                result = function->m_c_code(function, python_pars);
            } else {
                result = NULL;
            }
        ...
        if (method->m_object != NULL) {
            ...
            if (function->m_args_simple && 23 + 1 == function->m_args_positional_count) {
                ...
                if (parseArgumentsMethodPos(function, python_pars, method->m_object, args, 23)) {
                    result = function->m_c_code(function, python_pars);
                } else {
                    result = NULL;
                }
...
#if PYTHON_VERSION < 0x370
                result = (*(_PyCFunctionFast)method)(self, &PyTuple_GET_ITEM(pos_args, 0), 23, NULL);
#else
